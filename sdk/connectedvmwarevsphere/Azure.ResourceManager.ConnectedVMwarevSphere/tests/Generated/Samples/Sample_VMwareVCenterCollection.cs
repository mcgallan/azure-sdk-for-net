...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Samples
{
    public partial class Sample_VMwareVCenterCollection
    {
        ...
        {
            // Generated from example definition: 2023-12-01/CreateVCenter.json
            // this example is just showing the usage of "VCenter_Create" operation, for the dependent resources, they will have to be created separately.
            ...
            VMwareVCenterData data = new VMwareVCenterData(new AzureLocation("East US"), null)
            {
        ...
        {
            // Generated from example definition: 2023-12-01/ListVCentersByResourceGroup.json
            // this example is just showing the usage of "VCenter_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
