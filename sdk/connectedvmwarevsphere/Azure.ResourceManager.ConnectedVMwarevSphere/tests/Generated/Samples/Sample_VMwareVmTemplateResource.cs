...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Samples
{
    public partial class Sample_VMwareVmTemplateResource
    {
        ...
        {
            // Generated from example definition: 2023-12-01/DeleteVirtualMachineTemplate.json
            // this example is just showing the usage of "VirtualMachineTemplate_Delete" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: 2023-12-01/UpdateVirtualMachineTemplate.json
            // this example is just showing the usage of "VirtualMachineTemplate_Update" operation, for the dependent resources, they will have to be created separately.
