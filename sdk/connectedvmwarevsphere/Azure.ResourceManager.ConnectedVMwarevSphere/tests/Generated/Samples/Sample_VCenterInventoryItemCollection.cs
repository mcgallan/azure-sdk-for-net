...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Samples
{
    public partial class Sample_VCenterInventoryItemCollection
    {
        ...
        {
            // Generated from example definition: 2023-12-01/CreateInventoryItem.json
            // this example is just showing the usage of "InventoryItem_Create" operation, for the dependent resources, they will have to be created separately.
            ...
            VCenterInventoryItemData data = new VCenterInventoryItemData(new ResourcePoolInventoryItem());
        ...
        {
            // Generated from example definition: 2023-12-01/GetInventoryItem.json
            // this example is just showing the usage of "InventoryItem_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: 2023-12-01/InventoryItems_ListByVCenter.json
            // this example is just showing the usage of "InventoryItem_ListByVCenter" operation, for the dependent resources, they will have to be created separately.
