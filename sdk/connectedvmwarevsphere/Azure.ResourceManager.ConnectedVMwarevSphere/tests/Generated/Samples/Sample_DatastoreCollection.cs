...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Samples
{
    public partial class Sample_DatastoreCollection
    {
        ...
        {
            // Generated from example definition: 2023-12-01/CreateDatastore.json
            // this example is just showing the usage of "Datastore_Create" operation, for the dependent resources, they will have to be created separately.
            ...
            DatastoreCollection collection = resourceGroupResource.GetDatastores();

            // invoke the operation
            string datastoreName = "HRDatastore";
            DatastoreData data = new DatastoreData(new AzureLocation("East US"))
            {
        ...
        {
            // Generated from example definition: 2023-12-01/ListDatastoresByResourceGroup.json
            // this example is just showing the usage of "Datastore_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
