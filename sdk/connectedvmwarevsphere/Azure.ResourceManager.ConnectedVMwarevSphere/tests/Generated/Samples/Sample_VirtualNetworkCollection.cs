...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Samples
{
    public partial class Sample_VirtualNetworkCollection
    {
        ...
        {
            // Generated from example definition: 2023-12-01/CreateVirtualNetwork.json
            // this example is just showing the usage of "VirtualNetwork_Create" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: 2023-12-01/GetVirtualNetwork.json
        ...
        {
            // Generated from example definition: 2023-12-01/ListVirtualNetworksByResourceGroup.json
            // this example is just showing the usage of "VirtualNetwork_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
