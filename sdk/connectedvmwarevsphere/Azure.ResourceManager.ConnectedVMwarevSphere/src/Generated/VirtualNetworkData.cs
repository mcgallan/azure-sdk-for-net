...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class VirtualNetworkData : TrackedResourceData
    {
        ...
        internal VirtualNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string uuid, string vCenterId, string moRefId, string inventoryItemId, string moName, string customResourceName, IReadOnlyList<ResourceStatus> statuses, ProvisioningState? provisioningState, ExtendedLocation extendedLocation, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Uuid = uuid;
            VCenterId = vCenterId;
            MoRefId = moRefId;
