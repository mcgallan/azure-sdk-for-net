...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    /// Define the host.
    /// </summary>
    public partial class HostData : TrackedResourceData
    {
        /// <summary>
        ...
        public HostData(AzureLocation location) : base(location)
        {
        ...
        internal HostData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string uuid, string vCenterId, string moRefId, string inventoryItemId, string moName, IReadOnlyList<ResourceStatus> statuses, string customResourceName, long? overallMemoryUsageGB, long? memorySizeGB, long? overallCpuUsageMHz, long? cpuMhz, IReadOnlyList<string> datastoreIds, IReadOnlyList<string> networkIds, ProvisioningState? provisioningState, ExtendedLocation extendedLocation, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Uuid = uuid;
            VCenterId = vCenterId;
            MoRefId = moRefId;
        ...
        /// <summary> Initializes a new instance of <see cref="HostData"/> for deserialization. </summary>
        internal HostData()
        {
        }
