...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class ResourcePoolData : TrackedResourceData
    {
        ...
        internal ResourcePoolData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string uuid, string vCenterId, string moRefId, string inventoryItemId, string moName, string cpuSharesLevel, long? cpuReservationMHz, long? cpuLimitMHz, string memSharesLevel, long? memReservationMB, long? memLimitMB, long? memOverallUsageGB, long? memCapacityGB, long? cpuOverallUsageMHz, long? cpuCapacityMHz, string customResourceName, IReadOnlyList<string> datastoreIds, IReadOnlyList<string> networkIds, IReadOnlyList<ResourceStatus> statuses, ProvisioningState? provisioningState, ExtendedLocation extendedLocation, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Uuid = uuid;
            VCenterId = vCenterId;
            MoRefId = moRefId;
