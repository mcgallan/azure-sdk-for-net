...
{
    public partial class GuestAgent : IUtf8JsonSerializable, IJsonModel<GuestAgent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GuestAgent>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<GuestAgent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GuestAgent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GuestAgent)} does not support writing '{format}' format.");
            }
        ...
        GuestAgent IJsonModel<GuestAgent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GuestAgent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GuestAgent)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeGuestAgent(document.RootElement, options);
        }

        internal static GuestAgent DeserializeGuestAgent(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<GuestAgent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GuestAgent>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GuestAgent)} does not support writing '{options.Format}' format.");
            }
        }

        GuestAgent IPersistableModel<GuestAgent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GuestAgent>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GuestAgent)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<GuestAgent>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
