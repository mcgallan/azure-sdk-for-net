...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    internal partial class GuestAgentList : IUtf8JsonSerializable, IJsonModel<GuestAgentList>
    {
        ...
        internal static GuestAgentList DeserializeGuestAgentList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<GuestAgent> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<GuestAgent> array = new List<GuestAgent>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(GuestAgent.DeserializeGuestAgent(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new GuestAgentList(value, nextLink, serializedAdditionalRawData);
        }
