...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class VMwareResourceStatus
    {
        ...
        internal VMwareResourceStatus(string type, string status, string reason, string message, string severity, DateTimeOffset? lastUpdatedOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            Status = status;
            Reason = reason;
