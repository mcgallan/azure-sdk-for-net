...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class NetworkInterface
    {
        ...
        internal NetworkInterface(string name, string label, IReadOnlyList<string> ipAddresses, string macAddress, string networkId, NICType? nicType, PowerOnBootOption? powerOnBoot, string networkMoRefId, string networkMoName, int? deviceKey, NicIPSettings ipSettings, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Label = label;
