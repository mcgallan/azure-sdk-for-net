...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class ResourceStatus
    {
        ...
        internal ResourceStatus(string type, string status, string reason, string message, string severity, DateTimeOffset? lastUpdatedOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            Status = status;
            Reason = reason;
