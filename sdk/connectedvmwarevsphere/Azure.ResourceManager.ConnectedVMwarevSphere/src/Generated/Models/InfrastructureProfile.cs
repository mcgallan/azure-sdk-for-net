...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class InfrastructureProfile
    {
        ...
        internal InfrastructureProfile(string templateId, string vCenterId, string moRefId, string inventoryItemId, string moName, string folderPath, string instanceUuid, string smbiosUuid, FirmwareType? firmwareType, string customResourceName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
