...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class VirtualDiskUpdate
    {
        ...
        internal VirtualDiskUpdate(string name, int? diskSizeGB, int? deviceKey, DiskMode? diskMode, int? controllerKey, int? unitNumber, string deviceName, DiskType? diskType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
