...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourcePatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourcePatch)} does not support writing '{format}' format.");
            }
        ...
        ResourcePatch IJsonModel<ResourcePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourcePatch)} does not support reading '{format}' format.");
            }
        ...
        internal static ResourcePatch DeserializeResourcePatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourcePatch(tags ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ResourcePatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourcePatch)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ResourcePatch IPersistableModel<ResourcePatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourcePatch)} does not support reading '{options.Format}' format.");
            }
        }
