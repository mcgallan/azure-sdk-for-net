...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    internal class VirtualNetworkOperationSource : IOperationSource<VirtualNetworkResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<VirtualNetworkData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerConnectedVMwarevSphereContext.Default);
