...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class VCenterData : TrackedResourceData
    {
        ...
        internal VCenterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string uuid, string fqdn, int? port, string version, string instanceUuid, string connectionStatus, string customResourceName, VICredential credentials, IReadOnlyList<ResourceStatus> statuses, ProvisioningState? provisioningState, ExtendedLocation extendedLocation, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Uuid = uuid;
            Fqdn = fqdn;
            Port = port;
