...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    internal partial class VMInstanceGuestAgentsRestOperations
    {
        ...
        public async Task<Response<GuestAgent>> GetAsync(string resourceUri, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        GuestAgent value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, ModelSerializationExtensions.JsonDocumentOptions, cancellationToken).ConfigureAwait(false);
                        value = GuestAgent.DeserializeGuestAgent(document.RootElement);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceUri"/> is null. </exception>
        public Response<GuestAgent> Get(string resourceUri, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
        ...
        internal RequestUriBuilder CreateCreateRequestUri(string resourceUri, GuestAgent body)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/", false);
        ...
        internal HttpMessage CreateCreateRequest(string resourceUri, GuestAgent body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceUri"/> is null. </exception>
        public async Task<Response> CreateAsync(string resourceUri, GuestAgent body = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));

            using var message = CreateCreateRequest(resourceUri, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceUri"/> is null. </exception>
        public Response Create(string resourceUri, GuestAgent body = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceUri, nameof(resourceUri));
