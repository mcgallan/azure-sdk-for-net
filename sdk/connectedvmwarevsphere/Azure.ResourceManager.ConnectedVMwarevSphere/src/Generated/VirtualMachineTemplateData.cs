...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class VirtualMachineTemplateData : TrackedResourceData
    {
        ...
        internal VirtualMachineTemplateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string uuid, string vCenterId, string moRefId, string inventoryItemId, string moName, int? memorySizeMB, int? numCpus, int? numCoresPerSocket, OSType? osType, string osName, string folderPath, IReadOnlyList<NetworkInterface> networkInterfaces, IReadOnlyList<VirtualDisk> disks, string customResourceName, string toolsVersionStatus, string toolsVersion, FirmwareType? firmwareType, IReadOnlyList<ResourceStatus> statuses, ProvisioningState? provisioningState, ExtendedLocation extendedLocation, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Uuid = uuid;
            VCenterId = vCenterId;
            MoRefId = moRefId;
        ...
        /// <summary> Initializes a new instance of <see cref="VirtualMachineTemplateData"/> for deserialization. </summary>
        internal VirtualMachineTemplateData()
        {
        }
