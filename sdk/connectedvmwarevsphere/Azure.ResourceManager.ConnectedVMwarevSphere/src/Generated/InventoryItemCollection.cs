...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class InventoryItemCollection : ArmCollection, IEnumerable<InventoryItemResource>, IAsyncEnumerable<InventoryItemResource>
    {
        ...
        /// <description>InventoryItem_Create</description>
        /// </item>
        /// <item>
        ...
        /// <param name="inventoryItemName"> The name of the InventoryItem. </param>
        ...
        public virtual async Task<ArmOperation<InventoryItemResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string inventoryItemName, InventoryItemData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ConnectedVMwarevSphereArmOperation<InventoryItemResource>(Response.FromValue(new InventoryItemResource(Client, response), response.GetRawResponse()), rehydrationToken);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>InventoryItem_Get</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-12-01</description>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>InventoryItem_ListByVCenter</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-12-01</description>
