...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class VmInstanceGuestAgentResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _vmInstanceGuestAgentGuestAgentsClientDiagnostics;
        private readonly GuestAgentsRestOperations _vmInstanceGuestAgentGuestAgentsRestClient;
        ...
        {
            _vmInstanceGuestAgentGuestAgentsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ConnectedVMwarevSphere", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string vmInstanceGuestAgentGuestAgentsApiVersion);
            _vmInstanceGuestAgentGuestAgentsRestClient = new GuestAgentsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, vmInstanceGuestAgentGuestAgentsApiVersion);
#if DEBUG
        ...
        {
            using var scope = _vmInstanceGuestAgentGuestAgentsClientDiagnostics.CreateScope("VmInstanceGuestAgentResource.Get");
            scope.Start();
            try
            {
                var response = await _vmInstanceGuestAgentGuestAgentsRestClient.GetAsync(Id.Parent.Parent, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<VmInstanceGuestAgentResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vmInstanceGuestAgentGuestAgentsRestClient.Get(Id.Parent.Parent, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new VmInstanceGuestAgentResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _vmInstanceGuestAgentGuestAgentsClientDiagnostics.CreateScope("VmInstanceGuestAgentResource.Delete");
            scope.Start();
            try
            {
                var response = await _vmInstanceGuestAgentGuestAgentsRestClient.DeleteAsync(Id.Parent.Parent, cancellationToken).ConfigureAwait(false);
                var operation = new ConnectedVMwarevSphereArmOperation(_vmInstanceGuestAgentGuestAgentsClientDiagnostics, Pipeline, _vmInstanceGuestAgentGuestAgentsRestClient.CreateDeleteRequest(Id.Parent.Parent).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vmInstanceGuestAgentGuestAgentsRestClient.Delete(Id.Parent.Parent, cancellationToken);
                var operation = new ConnectedVMwarevSphereArmOperation(_vmInstanceGuestAgentGuestAgentsClientDiagnostics, Pipeline, _vmInstanceGuestAgentGuestAgentsRestClient.CreateDeleteRequest(Id.Parent.Parent).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<VmInstanceGuestAgentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, VmInstanceGuestAgentData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _vmInstanceGuestAgentGuestAgentsClientDiagnostics.CreateScope("VmInstanceGuestAgentResource.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _vmInstanceGuestAgentGuestAgentsRestClient.CreateAsync(Id.Parent.Parent, data, cancellationToken).ConfigureAwait(false);
                var operation = new ConnectedVMwarevSphereArmOperation<VmInstanceGuestAgentResource>(new VmInstanceGuestAgentOperationSource(Client), _vmInstanceGuestAgentGuestAgentsClientDiagnostics, Pipeline, _vmInstanceGuestAgentGuestAgentsRestClient.CreateCreateRequest(Id.Parent.Parent, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<VmInstanceGuestAgentResource> CreateOrUpdate(WaitUntil waitUntil, VmInstanceGuestAgentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vmInstanceGuestAgentGuestAgentsRestClient.Create(Id.Parent.Parent, data, cancellationToken);
                var operation = new ConnectedVMwarevSphereArmOperation<VmInstanceGuestAgentResource>(new VmInstanceGuestAgentOperationSource(Client), _vmInstanceGuestAgentGuestAgentsClientDiagnostics, Pipeline, _vmInstanceGuestAgentGuestAgentsRestClient.CreateCreateRequest(Id.Parent.Parent, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
