...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualMachineTemplateData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<VirtualMachineTemplateData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualMachineTemplateData)} does not support writing '{format}' format.");
            }
        ...
        VirtualMachineTemplateData IJsonModel<VirtualMachineTemplateData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VirtualMachineTemplateData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VirtualMachineTemplateData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VirtualMachineTemplateData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        VirtualMachineTemplateData IPersistableModel<VirtualMachineTemplateData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VirtualMachineTemplateData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<VirtualMachineTemplateData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
