...
namespace Azure.ResourceManager.SqlVirtualMachine
{
    ...
    public partial class SqlVmGroupResource : ArmResource
    {
        ...
        public virtual async Task<Response<SqlVmGroupResource>> UpdateAsync(SqlVmGroupPatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<SqlVmGroupResource> Update(SqlVmGroupPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
